  ...
  test("POST /users", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        blockedDate: CREATE_RESULT.blockedDate.toISOString(),
        createdAt: CREATE_RESULT.createdAt.toISOString(),
        deletedDate: CREATE_RESULT.deletedDate.toISOString(),
      ...
      .expect([
        {
          ...
          blockedDate: FIND_MANY_RESULT[0].blockedDate.toISOString(),
          createdAt: FIND_MANY_RESULT[0].createdAt.toISOString(),
          deletedDate: FIND_MANY_RESULT[0].deletedDate.toISOString(),
  ...
  test("GET /users/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        blockedDate: FIND_ONE_RESULT.blockedDate.toISOString(),
        createdAt: FIND_ONE_RESULT.createdAt.toISOString(),
        deletedDate: FIND_ONE_RESULT.deletedDate.toISOString(),
